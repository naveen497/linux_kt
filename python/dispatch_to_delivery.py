...
print "order count : " + str(count_group)
...
# target_file = 'disp_delivery.csv'
# target_file = 'disp_delivery'+str(t)+'.csv'
# with open(target_file, 'wb') as csvfile:
#     spamwriter = csv.writer(csvfile, delimiter=',')
#     columnTitleRow = 'DIFF','CARRIER_SERVICE_CODE'
...
for t in range(len(groups)):
	...
	# 	temp = str(-diff_temp/60),str(group_t)
	...
	for perc in range(len(perc_list)):
		...
		# print str(perc_list[perc])+"% in reverse order : " + str( result_act[1] ) 
